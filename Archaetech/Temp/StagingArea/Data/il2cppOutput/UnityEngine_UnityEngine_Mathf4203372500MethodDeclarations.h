...
extern "C"  float Mathf_SmoothDamp_m488292903 (Il2CppObject * __this /* static, unused */, float ___current0, float ___target1, float* ___currentVelocity2, float ___smoothTime3, const MethodInfo* method) IL2CPP_METHOD_ATTR;
